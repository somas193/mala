...
params_gp1.running.max_number_epochs = 10
...
data_handler_gp1 = mala.DataHandler(params_gp1)
inputs_folder_gp1 = "/home/kulkar74/MALA_fork/test-data/Be2/training_data/"
outputs_folder_gp1 = data_path+"outputs_density/"
additional_folder_gp1 = data_path+"additional_info_qeouts/"
# Add a snapshot we want to use in to the list.
...
model_gp1.covar_module.base_kernel.lengthscale = 1
model_gp1.likelihood.noise_covar.noise = 1e-14
