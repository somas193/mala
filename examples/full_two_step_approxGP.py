...
inducing_points = data_handler_gp1.get_inducing_points(100)
...
# Specify the training parameters.
params_gp2.running.max_number_epochs = 5

# This should be 1, and MALA will set it automatically to, if we don't.
params_gp2.running.mini_batch_size = 500
params_gp2.running.learning_rate = 0.05
...
printout("Read data: DONE.")
inducing_points = data_handler_gp2.get_inducing_points(100, params_gp2.model.no_of_latents)
#print(inducing_points)
...
actual_ed, _ = tester_gp2.test_snapshot(0)
...
np.save("/media/rofl/New Volume/TU Dresden/THESIS/integrated_energy", integrated_energy)